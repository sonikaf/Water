 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Sonika Finch");
		  toPrint += p1.toString("sfinch6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Scott Wolfe");
		  toPrint += p2.toString("swolfe8");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Chase Hamrick");
		  toPrint += p3.toString("whamrick3");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Alex O'Connell");
          toPrint += p4.toString("soconnell6");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Mike Adams");
          toPrint += p5.toString("madams75");
