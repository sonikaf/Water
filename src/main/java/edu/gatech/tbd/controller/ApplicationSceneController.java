...
public class ApplicationSceneController extends SceneController implements Initializable, MapComponentInitializedListener {
    ...
    public void mapInitialized() {
    	...
    	mapOptions.center(gatechLocation)
